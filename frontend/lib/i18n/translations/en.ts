export const en = {
  ...
  "sidebar.catalogImported": "Imported catalog",
  "sidebar.catalogFallback": "Mock fallback",
  "sidebar.products": "products",
  "sidebar.lastImport": "Last import",
  ...
  "geo.auditStatus": "Audit source",
  "geo.simulationStatus": "Simulation source",
  ...
  "geo.status.live": "Live AI",
  "geo.status.fallback": "Fallback",
  "geo.status.unavailable": "Unavailable",
  "geo.status.refreshing": "Refreshing",
  "geo.status.model": "Model:",
  "geo.status.configure":
    "Add OPENAI_API_KEY in Vercel or your local .env file to enable live AI results.",
  ...
  "launch.assetsTitle": "Exportable GEO Assets",
  "launch.feedPatch": "Merchant Center Feed Patch",
  "launch.intentPack": "ChatGPT Intent Pack",
  ...
  "launch.selectChannels": "Choose channels",
  "launch.channelSelectionHint":
    "Select the destinations where this product package should go live.",
  "launch.selectAtLeastOneChannel": "Select at least one channel to continue.",
  "launch.publishChannels": "Publish channels",
  "launch.selectedChannels": "Selected channels",
  ...
  "settings.source.workspace": "Imported workspace data",
  "settings.source.fallback": "Mock fallback catalog",
  "settings.lastImport": "Last import",
  "settings.notImported": "No import yet",
  "settings.importMethod": "Import method",
  "settings.analyticsTitle": "Activation Analytics",
  "settings.analyticsDesc":
    "Track the core actions that drive first value and repeated usage in this workspace.",
  "settings.recentActivity": "Recent activity",
  "settings.noActivity": "No tracked activity yet.",
  "settings.analytics.login": "Logins",
  "settings.analytics.import": "Imports",
  "settings.analytics.audit": "Audit runs",
  "settings.analytics.query": "Query runs",
  "settings.analytics.agent": "Agent opens",
  "settings.analytics.asset": "Asset exports",
  ...
  "importModal.csvTitle": "Upload a CSV catalog",
  "importModal.csvDesc":
    "Parse, validate, and preview a merchant catalog before it replaces the current workspace products.",
  "importModal.uploadCsv": "Choose CSV file",
  "importModal.demoTitle": "Or sync the demo catalog",
  "importModal.demoDesc":
    "Use a one-click platform sync to repopulate this workspace with the demo store catalog.",
  "importModal.previewTitle": "Preview catalog import",
  "importModal.validRows": "Valid rows",
  "importModal.invalidRows": "Invalid rows",
  "importModal.warnings": "Warnings",
  "importModal.recognizedColumns": "Recognized columns",
  "importModal.product": "Product",
  "importModal.brand": "Brand",
  "importModal.price": "Price",
  "importModal.status": "Status",
  "importModal.missingTitle": "Missing title",
  "importModal.invalid": "Invalid",
  "importModal.review": "Needs review",
  "importModal.ready": "Ready",
  "importModal.back": "Back",
  "importModal.importValidRows": "Import valid rows",
  "importModal.emptyFile": "The selected CSV is empty or missing headers.",
  "importModal.parseError": "AgentShelf could not parse this CSV file.",
} as const;
